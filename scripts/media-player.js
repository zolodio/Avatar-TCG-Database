...
(function () {
  ...
  bar.innerHTML = `
    ...
    <div class="mb-controls">
      ...
      <button class="mb-btn" id="mbRew"     title="Rewind 10 s"><i class="fas fa-rotate-left"></i></button>
      ...
      <button class="mb-btn" id="mbFwd"     title="Forward 10 s"><i class="fas fa-rotate-right"></i></button>
